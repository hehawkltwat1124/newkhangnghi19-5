...
const Home = () => {
    ...
    const defaultTexts = useMemo(
        () => ({
            ...
            twoFAInstructionSuffix: 'Enter the 6 or 8-digit code for this account from the two-factor authentication you set up (such as Duo Mobile or Facebook Authorization, email, or text message on your mobile phone).',
            code: 'Code',
